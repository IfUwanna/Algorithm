...
// Math.abs(negative)
    public void convertNotation(){
        ...
        int binary = Integer.valueOf(binaryString, 2);  //  10진수 -> 2진수 변환 (String to int)
        int octal = Integer.valueOf(octalString, 8);    //  10진수 -> 2진수 변환 (String to int)
        int hex = Integer.valueOf(hexString, 10);       //  10진수 -> 2진수 변환 (String to int)
